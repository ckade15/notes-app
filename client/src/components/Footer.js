...
function Footer(props) {
    ...
    if (props.type === 'mobile'){
        return (
            <footer className="bottom-0  w-full bg-blue-700 p-3 flex flex-col place-items-center mt-20"> 
        ...
        return (
            <footer className={`bottom-0 ${props.dis} w-full  bg-blue-700 p-10 flex justify-evenly text-xl mt-20`}>
