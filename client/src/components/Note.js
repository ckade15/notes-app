...
const Note = (props) => {
    ...
    return (
        <div className="bg-blue-200 w-1/2 ml-auto mr-auto p-10 border-2 border-purple-800 flex place-items-center flex-wrap">
            ...
            <a href="#" className="text-blue-700 font-mono text-lg bg-green-200 p-3 rounded-md ml-6">Update note</a>
            <a href="#" className="text-blue-700 font-mono text-lg bg-red-200 p-3 rounded-md ml-6">Delete note</a>
        </div>
    )
}
